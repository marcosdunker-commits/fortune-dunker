...
const ASSETS = [
  ...
  "./simbolos/bussola.webp",
  "./simbolos/papagaio.webp",
  "./simbolos/caveira.webp",
  "./simbolos/pistola.webp",
  "./simbolos/bomba.webp",
  "./simbolos/rum.webp",
  "./simbolos/mapa.webp",
  "./simbolos/cartaA.webp",
  "./simbolos/cartaK.webp",
  "./simbolos/cartaQ.webp",
  "./simbolos/cartaJ.webp",
  "./simbolos/carta10.webp",
  "./audio/sino.ogg",
  "./audio/fichas.ogg",
  "./audio/ficha-uma.ogg",
